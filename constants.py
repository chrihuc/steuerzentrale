...
class sql_tables:
    ...
    #command tables
    inputs          = sql_object("cmd_inputs", "Commands", (("Id","INT(11)","PRIMARY KEY","AUTO_INCREMENT"),("Input","VARCHAR(20)"),("Logging","tinyint(1)"),("Setting","tinyint(1)"), ("Value_lt","DECIMAL(5,2)"),("Value_eq","DECIMAL(5,2)"),("Value_gt","DECIMAL(5,2)"),( "Wach","VARCHAR(20)"), ("Schlafen","VARCHAR(20)"), ("Schlummern","VARCHAR(20)"),("Leise","VARCHAR(20)"), ("AmGehen","VARCHAR(20)"), ("Gegangen","VARCHAR(20)"), ("Abwesend","VARCHAR(20)"), ("Urlaub","VARCHAR(20)"), ("Besuch","VARCHAR(20)")))
    ...
    tables = [his_inputs,alarm_events,inputs,cron,wecker,settings,szenen,satellites,hue,LightstripSchlafzi,Marantz,Sideboard,Sonos,TuerSPi,Besucher,Bewohner]
